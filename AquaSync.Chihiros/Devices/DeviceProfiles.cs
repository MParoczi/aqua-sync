...
public static class DeviceProfiles
{
    ...
    public static DeviceProfile ZLightTiny { get; } = new(
        "Z Light TINY",
        ["DYSSD", "DYZSD"],
        [new(ColorChannel.White, 0), new(ColorChannel.Warm, 1)]);

    public static DeviceProfile TinyTerrariumEgg { get; } = new(
        "Tiny Terrarium Egg",
        ["DYDD"],
        [new(ColorChannel.Red, 0), new(ColorChannel.Green, 1)]);
    ...
    public static DeviceProfile CIIRGB { get; } = new(
        "C II RGB",
        ["DYNCRGP", "DYNCRGB"],
        [new(ColorChannel.Red, 0), new(ColorChannel.Green, 1), new(ColorChannel.Blue, 2)]);
    ...
    public static DeviceProfile WRGBIIPro { get; } = new(
        ...
        [new(ColorChannel.Red, 0), new(ColorChannel.Green, 1), new(ColorChannel.Blue, 2), new(ColorChannel.White, 3)]);
